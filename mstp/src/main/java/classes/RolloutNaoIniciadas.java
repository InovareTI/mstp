					    			    	...
					    			    	try {
					    						  ...
					    						  // System.out.println("controle3");
					    						   String strJsonBody = "{"
					    						                      ...
					    						                      +   "\"filters\": [{\"field\": \"tag\", \"key\": \"User\", \"relation\": \"=\", \"value\": \""+milestone.get("resp_"+milestone.getString("Milestone"))+"\"},{\"operator\": \"OR\"},{\"field\": \"tag\", \"key\": \"User\", \"relation\": \"=\", \"value\": \""+milestone.getString("resp_"+milestone.getString("Milestone")).toLowerCase()+"\"},{\"operator\": \"OR\"}, {\"field\": \"tag\", \"key\": \"User\", \"relation\": \"=\", \"value\": \""+milestone.getString("resp_"+milestone.getString("Milestone")).toUpperCase()+"\"}],"
					    						                      +   "\"data\": {\"foo\": \"bar\"},"
