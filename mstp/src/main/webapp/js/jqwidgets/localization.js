        ...
        case 'pt-BR':localization =
            ...
            thousandsseparator: '.',
             pagergotopagestring: 'Ir para:',
                    ...
                    groupsheaderstring: 'Arraste e solte a coluna para agrupar',
                    sortascendingstring: 'Crescente',
                    sortdescendingstring: 'Decrescente',
                    sortremovestring: 'Limpar',
                    groupbystring: 'Agrupar',
                    groupremovestring: 'Remove grupo',
                    filterclearstring: 'Limpar',
                    filterstring: 'Filtro',
                    filtershowrowstring: 'Exibir linhas aqui:',
                    ...
                    filterstringcomparisonoperators: ['vazio', 'não vazio', 'enthalten', 'enthalten(match case)',
                        'does not contain', 'does not contain(match case)', 'starts with', 'starts with(match case)',
                        'ends with', 'ends with(match case)', 'equal', 'equal(match case)', 'null', 'not null'],
                    filternumericcomparisonoperators: ['igual', 'diferente', 'less than', 'less than or equal', 'greater than', 'greater than or equal', 'null', 'not null'],
                    filterdatecomparisonoperators: ['igual', 'diferente', 'less than', 'less than or equal', 'greater than', 'greater than or equal', 'null', 'not null'],
                    filterbooleancomparisonoperators: ['igual', 'diferente'],
                    validationstring: 'Valor Inválido',
                    emptydatastring: 'Sem Informações',
