            ...
            localization =
                {
                    ...
                    groupsheaderstring: 'Arraste a coluna e solte aqui para agrupar por coluna',
                    sortascendingstring: 'Ordem Crescente',
                    sortdescendingstring: 'Ordem Decrescente',
                    sortremovestring: 'Limpar ordenação',
                    ...
                    filterselectallstring: '(Mostra Todos)',
                    filterchoosestring: 'Por favor escolha:',
                    filterstringcomparisonoperators: ['vazio', 'nao vazio', 'enthalten', 'enthalten(match case)',
                        'does not contain', 'does not contain(match case)', 'starts with', 'starts with(match case)',
                        'ends with', 'ends with(match case)', 'equal', 'equal(match case)', 'null', 'not null'],
                    filternumericcomparisonoperators: ['igual', 'diferente', 'menor que', 'menor que ou igual', 'maior que', 'maior que ou igual', 'nulo', 'not null'],
                    filterdatecomparisonoperators: ['igual', 'diferente', 'menor que', 'menor que ou igual', 'maior que', 'maior que ou igual', 'nulo', 'not null'],
                    filterbooleancomparisonoperators: ['igual', 'diferente'],
                    validationstring: 'Valores inválidos',
                    emptydatastring: 'Sem informação para exibir',
                    filterselectstring: 'Selecione o Filtro',
                    loadtext: 'Carregando',
                    clearstring: 'Limpar',
                    todaystring: 'Hoje'
                }
